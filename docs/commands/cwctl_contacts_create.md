## cwctl contacts create

Create a contact

```
cwctl contacts create [flags]
```

### Examples

```
  cwctl contacts create --data '{...}'
  cwctl contacts create -d @payload.json
```
...
```
  ...
  -h, --help                           help for create
      ...
      --inbox-id int                   inbox to attach the contact to
      --name string                    contact name
      --phone-number string            phone in E.164, e.g. +573001112233
```
