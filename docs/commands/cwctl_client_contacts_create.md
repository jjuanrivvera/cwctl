## cwctl client contacts create

Create a contact in a public inbox

```
cwctl client contacts create <inbox-identifier> [flags]
```

### Examples

```
  cwctl client contacts create Fbd1h… --name Ana --email ana@example.com
```
...
```
  ...
  -h, --help                       help for create
      ...
      --identifier-hash string     HMAC of identifier (identity validation)
