## cwctl integrations create-hook

Create an integration hook

```
cwctl integrations create-hook [flags]
```

### Examples

```
  cwctl integrations create-hook --app-id dialogflow --settings '{"project_id":"x","credentials":{}}' --inbox-id 3
```
