## cwctl integrations update-hook

Update an integration hook's settings

```
cwctl integrations update-hook <hook-id> [flags]
```

### Examples

```
  cwctl integrations update-hook 5 --settings '{"project_id":"y"}'
```
