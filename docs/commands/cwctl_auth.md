...
* [cwctl auth login](cwctl_auth_login.md)	 - Store a Chatwoot token and verify it
* [cwctl auth logout](cwctl_auth_logout.md)	 - Remove stored tokens for the active profile
* [cwctl auth status](cwctl_auth_status.md)	 - Show the active profile, base URL, identity, and token validity
