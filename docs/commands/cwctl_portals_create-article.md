## cwctl portals create-article

Add an article to a portal

```
cwctl portals create-article <portal-id> [flags]
```

### Examples

```
  cwctl portals create-article 1 --title "Cómo empezar" --content "..." --author-id 1 --category-id 2
```
