...
Generate agent-safety config that blocks destructive cwctl operations
...
```
cwctl agent guard --host <claude-code|codex|opencode> [flags]
```

### Examples

```
  cwctl agent guard --host claude-code
